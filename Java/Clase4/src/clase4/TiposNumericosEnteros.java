public class TiposNumericosEnteros {
    ...
    public static void main(String[] args) {
        /*
        byte aqui solo estÃ¡ declarando que numEnteroByte es un Byte, el 10
        es su propio tipo (int por defecto), por tanto el valor que estÃ© a la derecha
        siempre serÃ¡ int por defecto a menos que declaremos el tipo entre parentesis (ej. "<variable> = (byte) 10")
        */
        ...
        /* Cuando nos pasamos del rango ocurre
           algo que llamamos "perdida de precisiÃ³n" al convertir los diferentes tipos
